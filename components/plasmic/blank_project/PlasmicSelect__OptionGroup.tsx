...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: dwz3UlNQbjg/css
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__bhNfo)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__uJTvE)}
              />
            </React.Fragment>
          ),
          value: args.children
